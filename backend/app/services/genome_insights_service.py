    ...
    def _generate_insights(
        ...
        if total_tasks == 0:
            insights.append({
                ...
                "description": (
                    "Your Completion Genome is initializing. Create and complete "
                    "tasks to unlock personalized behavioral insights."
                ),
                "actionable": "Create your first task to begin building your genome.",
                "priority": "medium",
            })
            return insights
